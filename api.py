...
def token_required(f):
    ...
    def decorated(*args, **kwards):
        ...
        return f(current_user, *args, **kwards)
...
def promote_user(current_user, public_id):
    ...
    user.admin = True
    db.session.commit()
    return jsonify({'message': 'The user has been promotd!'})
...
def get_one_todo(current_user, todo_id):
    ...
    if not todo:
        return jsonify({'message': 'Nothing is to do!'})
    todo_data = {}
    todo_data['id'] = todo.id
    todo_data['text'] = todo.text
    todo_data['complete'] = todo.complete
...
def create_todos(current_user):
    ...
    db.session.commit()
    return jsonify ({'message' : 'Todo create task! '})
...
def complete_todo(current_user, todo_id):
    ...
    todo.complete = True
    db.session.commit()
    return jsonify({'message': 'The item TODO has been COMPLETE!'})
...
def delete_todo(current_user, todo_id):
    ...
    db.session.commit()
    return jsonify({'message': 'TOOD item has been DELETE!'})
